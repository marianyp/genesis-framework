...
import dev.mariany.genesisframework.advancement.criterion.OpenAdvancementTabTrigger;
...
public class GFInstructionProvider extends InstructionProvider {
    public GFInstructionProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookup) {
        ...
        Instruction.Builder
                ...
                .display(
                        ...
                        Component.translatable(
                                "instruction.genesisframework.view_ages.description",
                                Component.keybind(Minecraft.getInstance().options.keyAdvancements.getName())
                        )
                )
                .criterion(
                        "view_ages",
                        OpenAdvancementTabTrigger.TriggerInstance.create(AgeEntry.ROOT_ADVANCEMENT_ID)
                )
